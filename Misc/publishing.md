...
Publishing the group’s Working Drafts is done via a combination of GitHub and a W3C tool called [Echidna](https://github.com/w3c/echidna/wiki). The high-level points to remember are described below. (All the examples use the `json-ld-syntax` repository as an example, the other repositories are set up in a similar fashion.)
