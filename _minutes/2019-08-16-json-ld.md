...
**Rob Sanderson:** In framing context, I had a $MD_CODE$. I did various things in playground, and discovered that in framing, container:set does not get handled properly. It does work fine in compaction.  
