...
> *Theresa O'Connor:* I think it would make sense for CSS to also have a non-normative "there be dragons here" note and will file an issue on CSS Values to reflect that.
